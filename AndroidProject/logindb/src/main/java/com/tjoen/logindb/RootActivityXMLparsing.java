...
public class RootActivityXMLparsing extends AppCompatActivity {
    ...
    class  Hani{
        ...
        public String link;
        //객체를 문자열로 표현하는 메소드
        //출력하는 곳에 객체 이름을 설정하면 이 메소드의 호출 결과를 출력합니다.
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_root_xmlparsing);
                ...
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent = new Intent(
                                RootActivityXMLparsing.this, SubActivityXMLparsing.class
                        );
    ...
    public void onResume(){
        ...
        Thread th = new Thread(){
            ...
            public void run(){
                ...
                try{
                    //생성자를 이용해서 객체를 생성하지 않고
                    //Factory 클래스를 이용해서 생성하는 이유는 만드는 과정이 복잡한 경우에 개발자는 굳이
                    //생성하는 과정을 알 필요 없도록 하기 위해서 입니다.
